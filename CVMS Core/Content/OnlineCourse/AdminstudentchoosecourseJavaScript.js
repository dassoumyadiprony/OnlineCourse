...
function getchooscoursee() {
        ...
        success: function (data) {
            ...
            $.each(data.gdta, function (item, value) {
                ...
                row += "<td>" +
                    ...
                    "<button type='button' class='btn btn-sm btn-danger' data-id=''onclick='DeleteStudentCourseAdmin(" + value.id + ",event)'><i class='fa fa-trash' aria-hidden='true'></i></button>" +
                    "</td>";
    ...
    function DeleteStudentCourseAdmin(control, e) {
    debugger
    // ClearSubmitForm()
    e.preventDefault();
    //Id = cid;
    ...
    $.ajax({
        type: "POST",
        url: "../Index/DeleteChooseCOAdmin/" + id,
        dataType: "JSON",
